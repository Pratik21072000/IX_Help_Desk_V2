...
const Login: React.FC = () => {
  ...
  const demoUsers = [
    { username: "john.employee", role: "Employee" },
    { username: "admin.manager", role: "Admin Manager" },
    { username: "finance.manager", role: "Finance Manager" },
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-3">
          <div className="flex justify-center">
            <div className="bg-gradient-to-r from-incub-blue-500 to-incub-blue-600 p-4 rounded-2xl shadow-lg">
        ...
        <Card className="border border-incub-blue-100 bg-incub-blue-50/50 backdrop-blur-sm">
          ...
          <CardContent className="space-y-3">
            <p className="text-xs font-body text-incub-gray-600 mb-3">
              Use any of these usernames with any password:
            </p>
